...
// Use a unique session name for admin to avoid conflict with user sessions
        ...
        if ($row = mysqli_fetch_assoc($result)) {
            if (password_verify($password, $row['password'])) {
                ...
                if ($row['role'] === 'admin') {
                    ...
                    // Optional: Set cookies for persistence
                    ...
                    $message = "<p class='error'>Access denied. You are not an admin.</p>";
                }
            } else {
    ...
    <form action="" method="post" class="form-container p-3 py-4 px-4 bg-dark" style="background-color: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); width: 30vw;">
        <h2>Welcome to Salon!</h1>
            ...
            <div class="mt-2">
                ...
                <p>You must contact admin for more information...</p>
            </div>
